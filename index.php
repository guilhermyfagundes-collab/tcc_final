...
<body>
  ...
  <main id="main-content" class="page-shell">
    ...
    <section class="mode-section" aria-labelledby="mode-title"><div class="section-heading"><div><p class="eyebrow">ESCOLHA O DESAFIO</p><h2 id="mode-title">Qual será o nível da máquina?</h2></div><span class="step-label">01 <span aria-hidden="true">—</span> 02</span></div><div class="mode-grid"><button class="mode-card selected" data-difficulty="easy" type="button"><span class="mode-icon solo-icon" aria-hidden="true">+</span><span><strong>Fácil</strong><small>Apenas contas de adição</small></span><span class="radio-dot" aria-hidden="true"></span></button><button class="mode-card" data-difficulty="medium" type="button"><span class="mode-icon duo-icon" aria-hidden="true">−</span><span><strong>Médio</strong><small>Apenas contas de subtração</small></span><span class="radio-dot" aria-hidden="true"></span></button><button class="mode-card" data-difficulty="hard" type="button"><span class="mode-icon duo-icon" aria-hidden="true">×</span><span><strong>Difícil</strong><small>Apenas contas de multiplicação</small></span><span class="radio-dot" aria-hidden="true"></span></button></div></section>
